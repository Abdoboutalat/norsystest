package norsys.fr.web.rest;

import norsys.fr.config.Constants;
import norsys.fr.Test2App;
import norsys.fr.domain.Authority;
import norsys.fr.domain.User;
import norsys.fr.repository.AuthorityRepository;
import norsys.fr.repository.UserRepository;
import norsys.fr.security.AuthoritiesConstants;
import norsys.fr.service.MailService;
import norsys.fr.service.dto.UserDTO;
import norsys.fr.web.rest.errors.ExceptionTranslator;
import norsys.fr.web.rest.vm.KeyAndPasswordVM;
import norsys.fr.web.rest.vm.ManagedUserVM;
import norsys.fr.service.UserService;
